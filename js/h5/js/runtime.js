(function() {
	...
	Runtime.prototype.requestProjectData = function () {
		...
		console.log('runtime XMLHttpRequest')
		var datajs_filename = "http://act.cmcmcdn.com/liebao/wechatGame/data.json";
		if (this.isWindows8App || this.isWindowsPhone8 || this.isWindowsPhone81 || this.isWindows10)
			datajs_filename = "http://act.cmcmcdn.com/liebao/wechatGame/data.json";
		xhr.open("GET", datajs_filename);
	...
	Runtime.prototype.initRendererAndLoader = function () {
		...
		if (!this.isDomFree) {
			var unfocusFormControlFunc = function (e) {
				console.log('unfocusFormControlFunc e', e)
	...
	cr.runtime = Runtime;
	cr.createRuntime = function (canvas) {
